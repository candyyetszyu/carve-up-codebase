...
# Carve Up Codebase (Codex skill)

> The full procedure lives in `AGENTS.md` at this repo's root. Codex also
> reads `AGENTS.md` natively; this skill wrapper is here for explicit
